...
<div class="wrapper">
  ...
  <link rel="stylesheet" type="text/css" href="css/progilepage.css">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="view_profile.php?id=<?php echo $row['empid']; ?>" class="btn btn-info btn-sm view btn-flat">
                          <i class="fa fa-user"></i> View Profile
                        </a>
                        <button class="btn btn-success btn-sm edit btn-flat" data-id="<?php echo $row['empid']; ?>">
                          <i class="fa fa-edit"></i> Edit
                        </button>
                        <button class="btn btn-danger btn-sm delete btn-flat" data-id="<?php echo $row['empid']; ?>">
